...
object RepositoryModule {
    ...
    @Provides
    @JvmStatic
    fun provideMovieRepository(movieRoutes: MovieRoutes): MovieRepository =
        MovieRepositoryImpl(movieRoutes)


    @Provides
    @JvmStatic
    fun provideTvShowRepository(tvShowRoutes: TvShowRoutes): TvShowRepository =
        TvShowRepositoryImpl(tvShowRoutes)
}
